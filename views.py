...
def graphp():
    ...
    conclusion_preduction_rome_venise = "Suite aux données de la prévision, on remarque bien que  le nombre de personnes visitant  les sites de Rome et Venise décroît pendant l’année 2022 et 2023. \
